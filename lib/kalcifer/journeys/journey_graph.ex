defmodule Kalcifer.Journeys.JourneyGraph do
  ...
  @doc """
  Validates a journey graph structure.
  ...
  #
  # - `condition`: must have "true" and "false" branch edges
  # - `ab_split`: must have edges matching each variant key in config
  # - `wait_for_event`: must have timeout_branch and event_branch edges
